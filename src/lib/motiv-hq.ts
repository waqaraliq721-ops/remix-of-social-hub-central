...
export const HQ_TEMPLATES: HqTemplate[] = [
  ...
  {
    id: "hq-editorial-redline",
    name: "Editorial Redline",
    desc: "High-fashion monochrome portrait treatment, strict editorial grid and a razor-red kinetic accent line.",
    layout: "grungeRight",
    backdrop: "newsprint",
    backdropColor: "#dedbd3",
    textColor: "#111111",
    highlightColor: "#e1261c",
    font: "'Helvetica Neue', Arial, sans-serif",
    weight: "900",
    italic: false,
    uppercase: true,
    ...
    keepOriginalBg: false,
    particles: "none",
    controls: ["headline", "typography", "wordAnimation", "wordEditor", "subject", "backdrop", "camera", "signature"],
    cameraMotion: "parallax",
    duotone: true,
  },
  {
    id: "hq-midnight-orbit",
    name: "Midnight Orbit",
    desc: "A luminous halo and sparse celestial dust frame the subject while elegant serif lines float through depth.",
    layout: "haloBacklight",
    backdrop: "aurora",
    backdropColor: "#071427",
    textColor: "#eef5ff",
    highlightColor: "#74d3ff",
    font: "Georgia, 'Times New Roman', serif",
    weight: "700",
    italic: true,
    uppercase: false,
    ...
    keepOriginalBg: false,
    particles: "dust",
    controls: ["headline", "typography", "wordAnimation", "wordEditor", "subject", "backdrop", "particles", "camera"],
    cameraMotion: "breathe",
    duotone: false,
  },
  {
    id: "hq-chapter-zero",
    name: "Chapter Zero",
    desc: "An arthouse contact sheet with chapter numbers, warm film stock and restrained typewriter captions.",
    layout: "filmFrames",
    backdrop: "canvasoil",
    backdropColor: "#17110b",
    textColor: "#f0e4ce",
    highlightColor: "#ee8b3a",
    font: "'Courier New', monospace",
    weight: "700",
    italic: false,
    uppercase: true,
    ...
    keepOriginalBg: true,
    particles: "dust",
    controls: ["headline", "typography", "wordAnimation", "wordEditor", "backdrop", "particles", "camera", "signature"],
    cameraMotion: "zoomIn",
    duotone: false,
  },
  {
    id: "hq-electric-manifesto",
    name: "Electric Manifesto",
    desc: "Acid-neon terminal graphics, scanning typography and RGB impact frames for aggressive motivational edits.",
    layout: "glitchTerminal",
    backdrop: "voidsolid",
    backdropColor: "#050509",
    textColor: "#f6ff43",
    ...
    keepOriginalBg: false,
    particles: "sparks",
    controls: ["headline", "typography", "wordAnimation", "wordEditor", "subject", "backdrop", "particles", "camera", "layoutOptions"],
    cameraMotion: "handheld",
    duotone: false,
  },
];
