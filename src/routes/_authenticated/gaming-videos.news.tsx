...
export const Route = createFileRoute("/_authenticated/gaming-videos/news")({
  head: () => ({
    meta: [
      { title: "News — Gaming Videos — Orbit" },
      { name: "description", content: "Fast-turnaround gaming news recaps and update roundups." },
    ],
  }),
  component: NewsPage,
});
      ...
      <div className="relative overflow-hidden rounded-3xl border bg-gradient-to-br from-violet-600/15 via-fuchsia-500/10 to-orange-400/10 p-8">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="mt-2 max-w-2xl text-muted-foreground">Fast-turnaround gaming news recaps and update roundups.</p>
            <div className="mt-5">
      ...
      <Card className="border-dashed">
        <CardContent className="flex flex-col items-start gap-2 p-6">
          ...
          <p className="text-sm text-muted-foreground">
            We're building the News studio next. Let us know what you want to see first.
          </p>
        </CardContent>
      </Card>
    </div>
