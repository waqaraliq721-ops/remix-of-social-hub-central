...
export const Route = createFileRoute("/_authenticated/gaming-videos/memes")({
  head: () => ({
    meta: [
      { title: "Memes — Gaming Videos — Orbit" },
      { name: "description", content: "Meme compilations and reaction clips for the gaming community." },
    ],
  }),
  component: MemesPage,
});
      ...
      <div className="relative overflow-hidden rounded-3xl border bg-gradient-to-br from-violet-600/15 via-fuchsia-500/10 to-orange-400/10 p-8">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <h1 className="text-3xl font-semibold tracking-tight">Memes</h1>
            <p className="mt-2 max-w-2xl text-muted-foreground">Meme compilations and reaction clips for the gaming community.</p>
            <div className="mt-5">
      ...
      <Card className="border-dashed">
        <CardContent className="flex flex-col items-start gap-2 p-6">
          ...
          <p className="text-sm text-muted-foreground">
            We're building the Memes studio next. Let us know what you want to see first.
          </p>
        </CardContent>
      </Card>
    </div>
